...
public class WebServiceImplServiceLocator extends org.apache.axis.client.Service implements net.virtuemart.www.customers.WebServiceImplService {
    ...
    public net.virtuemart.www.customers.WebServiceImpl getWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.virtuemart.www.customers.WebServiceSoapBindingStub _stub = new net.virtuemart.www.customers.WebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.virtuemart.www.customers.WebServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                net.virtuemart.www.customers.WebServiceSoapBindingStub _stub = new net.virtuemart.www.customers.WebServiceSoapBindingStub(new java.net.URL(WebService_address), this);
                _stub.setPortName(getWebServiceWSDDServiceName());
                return _stub;
            }
        }
