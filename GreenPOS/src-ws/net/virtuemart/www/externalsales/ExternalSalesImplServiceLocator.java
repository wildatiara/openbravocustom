...
public class ExternalSalesImplServiceLocator extends org.apache.axis.client.Service implements net.virtuemart.www.externalsales.ExternalSalesImplService {
    ...
    public net.virtuemart.www.externalsales.ExternalSalesImpl getExternalSales(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.virtuemart.www.externalsales.ExternalSalesSoapBindingStub _stub = new net.virtuemart.www.externalsales.ExternalSalesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.virtuemart.www.externalsales.ExternalSalesImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                net.virtuemart.www.externalsales.ExternalSalesSoapBindingStub _stub = new net.virtuemart.www.externalsales.ExternalSalesSoapBindingStub(new java.net.URL(ExternalSales_address), this);
                _stub.setPortName(getExternalSalesWSDDServiceName());
                return _stub;
            }
        }
